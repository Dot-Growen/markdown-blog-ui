        ...
        <>
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button className="btn-modal1 btn" key="submit" type="primary" loading={loading} onClick={handleSubmit}>
                        Confirm Deletion
                    </Button>,
                ]}
            >
...
const Blockquote = (props) => {
    console.log(props)
    return (
        <Message color='black' message={props.value ? props.value : props.children} />
    )
}
